...
namespace Hellmade.Sound
{
    ...
    public class EazySoundManager : MonoBehaviour
    {
        ...
        public static int CountPlayingUISounds(AudioClip audioClip)
        {
            return CountPlayingAudio(Audio.AudioType.UISound, audioClip);
        }
        ...
        private static int CountPlayingAudio(Audio.AudioType audioType, AudioClip audioClip)
        {
            if (audioClip == null)
            {
                return 0;
